...
##### 0.0.0.0 A类地址中的第一个地址
##### 只可能作为源地址进行通信，只可能出现在DHCP协议，向DHCP服务器发起请求，请求信息需要封装在IP分组内来发送，而对于Ip分组来说，必须指明源和目的，目的就是DHCP服务器，而源就是发送者，但是发送者并不知道自己的IP地址，因此在这种非常特殊的情况下，它所发送的请求之中，分组的源IP地址为0.0.0.0
